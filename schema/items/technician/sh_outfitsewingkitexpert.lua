ITEM.name = "Expert Outfit Sewing Kit"
ITEM.model = "models/kek1ch/sewing_kit_h.mdl"
ITEM.description = "Top-quality material for top-quality work.."
ITEM.longdesc = "A top-shelf, fully packed kit fulled with high quality needles and thread that can help mend some pretty nasty damage."
ITEM.flag = "3"
ITEM.category = "Technician"
ITEM.price = 10000
ITEM.repairAmount = 8
ITEM.repairTreshhold = 45
ITEM.maxStack = 4
