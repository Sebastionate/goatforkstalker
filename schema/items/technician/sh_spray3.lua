ITEM.name = "'Brunox Gun Care' Spray Lubricant"
ITEM.model = "models/kek1ch/gun_oil.mdl"
ITEM.description = "A preventative gun application spray."
ITEM.longdesc = "A spraycan of lubricant that promises to prevent rusting, seizing, and dirt build-up if applied regularly to a firearm."
ITEM.flag = "3"
