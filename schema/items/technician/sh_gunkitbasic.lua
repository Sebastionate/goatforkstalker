ITEM.name = "Basic Gunsmith Toolkit"
ITEM.description = "Used by newer gunsmiths to maintain and modify firearms."
ITEM.longdesc = "A set of basic tools and parts for disassembling, cleaning, and reassembling more common firearms."
