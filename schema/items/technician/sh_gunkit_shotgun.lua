...
ITEM.description = "A set of weapon cleaning tools for shotguns."
ITEM.longdesc = "A set of brushes, oils, and solvents that is used to repair Shotguns."
ITEM.flag = "3"
		...
		if (char) then
			...
			if (inv) then
				...
				for k, v in pairs(items) do
					if v.isWeapon and v.weaponType == "closequarters" and item.repairTreshhold < (v:GetData("durability", 0)) and v:GetData("durability", 0) < 10000 then
