ITEM.name = "Heavy Weapons Cleaning Kit"
ITEM.model = "models/kek1ch/cleaning_kit_r7.mdl"
ITEM.description = "A set of weapon cleaning tools for heavy weapons."
ITEM.longdesc = "A set of brushes, oils, and solvents that is used to repair heavy weapons such as Machine Guns."
ITEM.flag = "3"
		...
		if (char) then
			...
			if (inv) then
				...
				for k, v in pairs(items) do
					if v.isWeapon and v.weaponType == "heavyweapons" and item.repairTreshhold < (v:GetData("durability", 0)) and v:GetData("durability", 0) < 10000 then
