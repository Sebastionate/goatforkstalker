ITEM.name = "Advanced Outfit Sewing Kit"
ITEM.model = "models/sewing_kit_a.mdl"
ITEM.description = "Higher quality tools and materials for taking care of damaged outfits."
ITEM.longdesc = "A better sewing kit than the norm, with high strength needles, quality nylon threads, and other items that make it useful on more intense repair jobs."
ITEM.flag = "3"
ITEM.category = "Technician"
ITEM.price = 5000
ITEM.repairAmount = 8
ITEM.repairTreshhold = 65
ITEM.maxStack = 4
