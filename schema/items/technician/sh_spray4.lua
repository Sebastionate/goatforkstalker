ITEM.name = "'Hoppe's Number 9' Cleaning Solvent"
ITEM.model = "models/kek1ch/solvent.mdl"
ITEM.description = "A western-made cleaning solvent."
ITEM.longdesc = "A Western-made, high quality cleaning solvent that is capable of cleaning and protecting guns to a very high degree."
ITEM.flag = "3"
ITEM.category = "Technician"
ITEM.repairAmount = 1500
ITEM.repairTreshhold = 3000
ITEM.maxStack = 5
