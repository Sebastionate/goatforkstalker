ITEM.name = "'Dvojka' Cleaning Solvent"
ITEM.model = "models/kek1ch/gun_oil_ru_d.mdl"
ITEM.description = "A weapon cleaning oil/solvent kit."
ITEM.longdesc = "A Red Army classic, with seperate compartments for oil and solvent, bound to help restore any gun that's seen better days look good as new."
ITEM.flag = "3"
ITEM.category = "Technician"
ITEM.repairAmount = 1500
ITEM.repairTreshhold = 5000
ITEM.maxStack = 5
