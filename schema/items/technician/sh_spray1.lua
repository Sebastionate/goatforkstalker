ITEM.name = "'Rusak' Gun Oil"
ITEM.model = "models/kek1ch/gun_oil_ru.mdl"
ITEM.description = "Mineral oils for weapon cleaning."
ITEM.longdesc = "A budget mineral oil that can be used with a simple brush to clean some gunk off a weapon."
ITEM.flag = "3"
ITEM.category = "Technician"
ITEM.repairAmount = 600
ITEM.repairTreshhold = 6000
ITEM.maxStack = 5
