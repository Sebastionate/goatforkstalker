ITEM.name = "'Zviezda' Glue Tube"
ITEM.model = "models/kek1ch/glue_b.mdl"
ITEM.description = "A cheap craft glue."
ITEM.longdesc = "A small tube of typical hobby store expoxy, good for restoring very minor tears in a suit's fabric."
ITEM.flag = "3"
