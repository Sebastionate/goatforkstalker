ITEM.name = "Small Arms Cleaning Kit"
ITEM.model = "models/kek1ch/cleaning_kit_p.mdl"
ITEM.description = "A set of weapon cleaning tools for smaller arms."
ITEM.longdesc = "A set of brushes, oils, and solvents that is used to repair small-arms weaponry such as Pistols and Submachine Guns."
ITEM.flag = "3"
ITEM.category = "Technician"
ITEM.repairAmount = 1500
ITEM.repairTreshhold = 1000
ITEM.maxStack = 5
		...
		if (char) then
			...
			if (inv) then
				...
				for k, v in pairs(items) do
					if v.isWeapon and v.weaponType == "smallarms" and item.repairTreshhold < (v:GetData("durability", 0)) and v:GetData("durability", 0) < 10000 then
