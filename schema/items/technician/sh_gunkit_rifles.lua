...
ITEM.description = "A set of weapon cleaning tools for rifles."
ITEM.longdesc = "A set of brushes, oils, and solvents that is used to repair semi, bolt action, or fully automatic rifles."
ITEM.flag = "3"
		...
		if (char) then
			...
			if (inv) then
				...
				for k, v in pairs(items) do
					if v.isWeapon and v.weaponType == "rifles" and item.repairTreshhold < (v:GetData("durability", 0)) and v:GetData("durability", 0) < 10000 then
