ITEM.name = "Advanced Gunsmith Toolkit"
ITEM.description = "Used by seasoned gunsmiths to maintain more complex firearms."
ITEM.longdesc = "A set of tools and replacement parts for working on both more basic weaponry and firearms using unusual proprietary parts, tools, or systems."
