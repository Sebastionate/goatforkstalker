ITEM.name = "'Tur' Glue Tube"
ITEM.model = "models/kek1ch/glue_a.mdl"
ITEM.description = "A fairly sturdy industrial epoxy."
ITEM.longdesc = "A small tube of Industrial-strength glue, used to quickly and effectively bond textiles. It's quite useful for mending torn materials in suits."
ITEM.flag = "3"
