ITEM.name = "Pickaxe"
ITEM.description = "A double-sided sharp implement used for collecting ores. Has a comfort rubber grip.\n\nAttacks:\n\n-Strength based Gash attack, -10 Strength, causes Light Bleeds.\n\n-Strength based Precision Strike, -20 Strength, causes Extreme Bleeds, and extreme damage."
