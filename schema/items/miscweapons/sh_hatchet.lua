ITEM.name = "Hatchet"
ITEM.description = "One handed light hatchet for utility or combat use.\n\nAttacks:\n\n-Strength based Minor Chop attack, -5 Strength, causes Moderate Bleeding.\n\n-Strength based Heavy Chop attack, -10 Strength, causes Heavy Bleeding, deals heavier damage."
