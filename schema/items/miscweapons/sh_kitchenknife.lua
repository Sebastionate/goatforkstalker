ITEM.name = "Knife"
ITEM.description = "For stabbin' stuff, or cooking a delicious meal.\n\nAttacks:\n\n-Reflex based Slash attack, No Modifier, causes Light Bleeding.\n\n-Reflex based stab attack, -10 Reflex, causes Moderate Bleeds and deals a little extra damage."
