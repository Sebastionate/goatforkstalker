ITEM.name = "Lead Pipe"
ITEM.description = "A thick metal pipe suitable as an improvised blunt weapon.\n\nAttacks:\n\n-Strength based Bash attack, No Modifier.\n\n-Strength based Heavy Bash attack, -5 Strength, deals a little extra damage."
