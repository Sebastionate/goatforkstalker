ITEM.name = "Fireaxe"
ITEM.description = "A cutting tool used by heroes and psychopaths.\n\nAttacks:\n\n-Strength based minor-chop attack, -10 Strength, causes Moderate bleeds.\n\n-Strength based Heavy Chop attack, -20 Strength, causes Heavy Bleeds, deals heavy amounts of damage."
