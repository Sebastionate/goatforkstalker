ITEM.name = "OKP-7 Red Dot Sight"
ITEM.description = "The OKP-7 is a Russian reflex sight developed for the AK series of assault rifles."
ITEM.category = "Attachments"
ITEM.model = "models/silver/stalker/items/a_okp.mdl"
ITEM.width = 1
ITEM.height = 1
ITEM.price = 5250
ITEM.slot = 1
ITEM.isAttachment = true
ITEM.attSearch = { "cw_sil_okp7_optic" }
ITEM.weight = 0.4
