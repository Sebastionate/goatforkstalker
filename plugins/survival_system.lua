...
function PLUGIN:HUDPaint()
	...
	local thirst = Material("ui/hud/thirst_green.png", "noclamp smooth") 
	local thirst2 = Material("ui/hud/thirst_yellow.png", "noclamp smooth") 
	local thirst3 = Material("ui/hud/thirst_orange.png", "noclamp smooth") 
	local thirst4 = Material("ui/hud/thirst_red.png", "noclamp smooth") 
